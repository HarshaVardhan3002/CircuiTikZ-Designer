...
export interface ImportDiagnostic {
	...
	code?: string
	/**
	 * Vision imports only. 0..1 model confidence carried into the diagnostic so the report modal
	 * can render a Confidence column.
	 */
	confidence?: number
	/**
	 * Vision imports only. The detection-time component id this diagnostic refers to. Allows the
	 * report row to link to the canvas component.
	 */
	componentRef?: string
}
